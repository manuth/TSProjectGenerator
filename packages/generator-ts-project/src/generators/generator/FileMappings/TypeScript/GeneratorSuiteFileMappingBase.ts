 ...
 */
export abstract class GeneratorSuiteFileMappingBase<TSettings extends ITSProjectSettings, TOptions extends GeneratorOptions> extends SuiteFileMapping<TSettings, TOptions>
{
    /**
